...
public class TenagaListrik extends Activity {

	EditText jawaban;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tenaga_listrik);
	...
	public void cekjawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(),TuaBangka.class);
			startActivity(i);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tenaga_listrik, menu);
		return true;
	}
