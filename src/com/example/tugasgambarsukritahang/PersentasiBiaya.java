package com.example.tugasgambarsukritahang;
...
public class PersentasiBiaya extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_persentasi_biaya);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "PERSENTASI BIAYA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(),TenagaListrik.class);
			startActivity(i);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.persentasi_biaya, menu);
		return true;
	}
