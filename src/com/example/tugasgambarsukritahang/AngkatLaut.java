...
public class AngkatLaut extends Activity {
	...
	public void cekjawaban(View v){
		String jawabanBenar = "ANGKATAN LAUT";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(),DaunBayam.class);
			startActivity(i);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.angkat_laut, menu);
		return true;
	}
