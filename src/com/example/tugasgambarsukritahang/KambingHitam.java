...
public class KambingHitam extends Activity {

	EditText jawaban;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kambing_hitam);
	...
	public void cekjawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(),KipasUdang.class);
			startActivity(i);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kambing_hitam, menu);
		return true;
	}
